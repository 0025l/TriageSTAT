...
public class TriaseMerahActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_triase_merah);
        ...
        btSubmit1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!isEmpty(nama.getText().toString()))
                    ...
                    submitBerjalan(new Korban(nama.getText().toString(), radioSexButton.getText().toString(), usia.getText().toString(), tmpt_tgl.getText().toString(),"Merah"));
 ...
 */
        ...
        database.child("korban").push().setValue(korban).addOnSuccessListener(TriaseMerahActivity.this, new OnSuccessListener<Void>() {

            @Override

            public void onSuccess(Void aVoid) {

                Intent intent = new Intent(TriaseMerahActivity.this, HomeActivity.class);
                startActivity(intent);
