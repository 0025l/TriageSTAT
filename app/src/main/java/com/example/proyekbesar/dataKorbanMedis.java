...
public class dataKorbanMedis extends AppCompatActivity implements AdapterKorbanRecyclerView2.FirebaseDataListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_korban_medis);
        /**

         * Inisialisasi RecyclerView & komponennya

         */
        rvView = (RecyclerView) findViewById(R.id.rv_main2);
 ...
 */
                ...
                adapter = new AdapterKorbanRecyclerView(daftarKorban, dataKorbanMedis.this);
 ...
 */
    ...
    public static Intent getActIntent(Activity activity){
        ...
        return new Intent(activity, dataKorbanMedis.class);
        ...
        if(database!=null){ database.child("korban").child(korban.getKey()).removeValue().addOnSuccessListener(new
                                                                                                                       OnSuccessListener<Void>() {
                                                                                                                           ...
                                                                                                                           public void onSuccess(Void aVoid) {
                                                                                                                               ...
                                                                                                                               Toast.makeText(dataKorbanMedis.this,"success delete", Toast.LENGTH_LONG).show();
