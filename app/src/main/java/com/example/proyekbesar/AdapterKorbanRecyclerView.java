...
public class AdapterKorbanRecyclerView extends RecyclerView.Adapter<AdapterKorbanRecyclerView.ViewHolder>
{
    ...
    public AdapterKorbanRecyclerView(ArrayList<Korban> korbans, Context ctx){
